...
/** Editor toolbar, 8x8 mono. */
export const UNDO: Bitmap = [
  '........',
  '..#.....',
  '.##.....',
  '#####...',
...
export const REDO: Bitmap = UNDO.map((row) => [...row].reverse().join(''))

export const PENCIL: Bitmap = [
  '......##',
  '.....###',
  '....###.',
  '...###..',
